...
class DatasetBuilder(object):
    ...
    @classmethod
    def rename_files(cls, source_folder, target_folder, name = '', extensions=('.jpg', '.jpeg', '.png')): #Added name - AV 5/17/17
        ...
        for filename in os.listdir(source_folder):
            if os.path.isdir(source_folder + '/' + filename):
                cls.rename_files(source_folder + '/' + filename,
				 ...
				 name=name, extensions=extensions) #Added name -AV 5/17/17
            else:
                if extensions == '' and os.path.splitext(filename)[1] == '':
                    ...
                    for extension in extensions:
                        if filename.endswith(extension):
                            copy2(source_folder + "/" + filename,
                                  target_folder + "/" + name + str(cls.rename_files_counter) + extension) #Added name -AV 5/17/17
                            cls.rename_files_counter += 1
