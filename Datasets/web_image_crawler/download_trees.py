...
keywords = ["tree"]
'''
api_keys = {'google': ('AIzaSyDT6IRIV3TYfNsL15fTHt4f0qme1Fd7guY', '016258986491633264514:23opqqbvivi'),
            'flickr': ('215ecc4da6befe05d9339d7832a74235', '1b2170cb6b96453d')} #Google error -AV 5/17/17
            '''
api_keys = {'flickr': ('215ecc4da6befe05d9339d7832a74235', '1b2170cb6b96453d')}

images_nbr = 3700 # number of images to fetch
download_folder = "./tree_images" # folder in which the images will be stored
...
crawler.save_urls(download_folder + "/tree_images_links.txt")
...
dataset_builder.rename_files(source_folder, target_folder, name = 'tree')
